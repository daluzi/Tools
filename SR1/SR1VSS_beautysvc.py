...
# @Author   : daluzi
# @time     : 2019/10/28 14:25
# @File     : SR1VSS_beautysvc.py
# @Software : PyCharm
...
def ProData(dataSet):
	...
	user_item_matrix = np.zeros((5466, 8495))
...
class SR1:
	...
	def __init__(self,filepath,k):
		...
		U, V = self.Update(train, k, 10, 0.001, 0.001, 0.001, 0.005)
		print("----------------------------------------------")
		print("U:\n",U)
		print("V:\n",V)
		new = np.dot(U.T, V)
...
if __name__ == '__main__':
	filePath = './beautysvc/ratings.txt'
	k = 10
	sr1 = SR1(filePath, k)
